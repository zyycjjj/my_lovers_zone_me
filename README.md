...
Create a `.env` file based on your database and runtime:

```
DATABASE_URL="mysql://USER:PASSWORD@hk-cdb-blgeg3yh.sql.tencentcdb.com:21348/love_prod"
PORT=4000
...
AI_MAX_TOKENS=1200
ADMIN_ACCOUNT_IDS=""
ADMIN_ACCOUNT_PHONES="13800138000"
...
```
sudo cp deploy/my-lovers-zone.service /etc/systemd/system/my-lovers-zone.service
sudo systemctl daemon-reload
sudo systemctl enable my-lovers-zone
```

Set deploy env and push:
